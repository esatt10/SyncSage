"""Landing bytes uploaded through the UI into a real, indexable source.

The point of this module is that uploading a document is **not** a second
...
filename supplied by a browser and turning it into a path we are willing to
write to.
"""
