...
pheasant connector contract asserted for free — the same bar the built-in
...
from pheasant.sync.connectors import ConnectorItem, ItemNotModified, SourceConnector
