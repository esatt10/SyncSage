...
PROFILES: dict[str, dict[str, Any]] = {
    "quickstart": {
        "syncsage": {"environment": "local", "log_level": "INFO"},
        "server": {
            "host": "127.0.0.1",
            "port": 8765,
    ...
    "cloud-hybrid": {
        "syncsage": {"environment": "cloud-hybrid", "log_level": "INFO"},
