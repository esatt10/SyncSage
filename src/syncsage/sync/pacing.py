...
Set ``SYNCSAGE_SYNC_YIELD_MS=0`` to turn it off, for a batch index with nobody
watching.
"""
...
SYNC_YIELD_S = max(0.0, float(os.environ.get("SYNCSAGE_SYNC_YIELD_MS", "1") or 0)) / 1000.0
