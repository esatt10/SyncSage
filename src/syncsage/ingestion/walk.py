...
SyncSage supports pointing a source at any path the operator can read —
...
@dataclass
class WalkReport:
    """What a walk found. Also the payload behind ``syncsage scan``."""
...
def budget_message(source_name: str, report: WalkReport, budget: WalkBudget) -> str:
    ...
    return (
        ...
        "patterns; run `syncsage scan` to see the shape first; or raise "
